...
from .views import (
    ...
    HomebrewContentViewSet, SpellViewSet, WeaponPropertyViewSet, EquipmentViewSet,
)
...
router.register('weapon-properties', WeaponPropertyViewSet, basename='weapon-properties')
