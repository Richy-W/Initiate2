...
IMPORTANT â€” ONE-TIME BOOTSTRAP:
This command provides an initial seed of spell records. It is NOT the
authoritative catalog. The api/content/spells/spells-*.json files (consumed by
`update_spell_data`) are the canonical source. Any new spells should be added
to those JSON files first and then loaded via `python manage.py update_spell_data`.
Running this command again after update_spell_data may overwrite enriched data.
"""
...
SPELL_DATA = [
    # ------------------------------------------------------------------ CANTRIPS
    ("Acid Splash", 0, "Conjuration", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Blade Ward", 0, "Abjuration", "Action", "Self", "Concentration, up to 1 minute", True, False,
    ...
    ("Chill Touch", 0, "Necromancy", "Action", "Touch", "Instantaneous", False, False,
    ...
    ("Dancing Lights", 0, "Illusion", "Action", "120 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Eldritch Blast", 0, "Evocation", "Action", "120 feet", "Instantaneous", False, False,
    ...
    ("Fire Bolt", 0, "Evocation", "Action", "120 feet", "Instantaneous", False, False,
     ["Sorcerer", "Wizard"], "Hurl a mote of fire at a creature. Make a ranged spell attack. On a hit, deal 1d10 fire damage."),
    ("Friends", 0, "Enchantment", "Action", "Self", "Concentration, up to 1 minute", True, False,
    ...
    ("Guidance", 0, "Divination", "Action", "Touch", "Concentration, up to 1 minute", True, False,
    ...
    ("Light", 0, "Evocation", "Action", "Touch", "1 hour", False, False,
    ...
    ("Mage Hand", 0, "Conjuration", "Action", "30 feet", "1 minute", False, False,
    ...
    ("Prestidigitation", 0, "Transmutation", "Action", "10 feet", "Up to 1 hour", False, False,
    ...
    ("Ray of Frost", 0, "Evocation", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Sacred Flame", 0, "Evocation", "Action", "60 feet", "Instantaneous", False, False,
     ["Cleric"], "Flame-like radiance descends on a creature. It must succeed on a Dexterity saving throw or take 1d8 radiant damage."),
    ("Shillelagh", 0, "Transmutation", "Bonus Action", "Self", "1 minute", False, False,
    ...
    ("Shocking Grasp", 0, "Evocation", "Action", "Touch", "Instantaneous", False, False,
    ...
    ("Spare the Dying", 0, "Necromancy", "Action", "Touch", "Instantaneous", False, False,
     ["Cleric", "Druid"], "Touch a living creature with 0 hit points. The creature becomes stable."),
    ("Thaumaturgy", 0, "Transmutation", "Action", "30 feet", "Up to 1 minute", False, False,
    ...
    ("Thunderclap", 0, "Evocation", "Action", "Self (5-foot radius)", "Instantaneous", False, False,
    ...
    ("Toll the Dead", 0, "Necromancy", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("True Strike", 0, "Divination", "Action", "Self", "Concentration, up to 1 round", True, False,
    ...
    ("Vicious Mockery", 0, "Enchantment", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Word of Radiance", 0, "Evocation", "Action", "Self (5-foot radius)", "Instantaneous", False, False,
    ...
    ("Animal Friendship", 1, "Enchantment", "Action", "30 feet", "24 hours", False, False,
    ...
    ("Armor of Agathys", 1, "Abjuration", "Action", "Self", "1 hour", False, False,
    ...
    ("Arms of Hadar", 1, "Conjuration", "Action", "Self (10-foot radius)", "Instantaneous", False, False,
    ...
    ("Bane", 1, "Enchantment", "Action", "30 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Bless", 1, "Enchantment", "Action", "30 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Burning Hands", 1, "Evocation", "Action", "Self (15-foot cone)", "Instantaneous", False, False,
    ...
    ("Charm Person", 1, "Enchantment", "Action", "30 feet", "1 hour", False, False,
    ...
    ("Color Spray", 1, "Illusion", "Action", "Self (15-foot cone)", "1 round", False, False,
    ...
    ("Command", 1, "Enchantment", "Action", "60 feet", "1 round", False, False,
    ...
    ("Compelled Duel", 1, "Enchantment", "Bonus Action", "30 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Comprehend Languages", 1, "Divination", "Action", "Self", "1 hour", False, True,
    ...
    ("Create or Destroy Water", 1, "Transmutation", "Action", "30 feet", "Instantaneous", False, False,
    ...
    ("Cure Wounds", 1, "Abjuration", "Action", "Touch", "Instantaneous", False, False,
     ["Bard", "Cleric", "Druid", "Paladin", "Ranger"], "A creature you touch regains 1d8 + your spellcasting ability modifier hit points."),
    ("Detect Magic", 1, "Divination", "Action", "Self", "Concentration, up to 10 minutes", True, True,
    ...
    ("Detect Poison and Disease", 1, "Divination", "Action", "Self", "Concentration, up to 10 minutes", True, True,
    ...
    ("Disguise Self", 1, "Illusion", "Action", "Self", "1 hour", False, False,
    ...
    ("Dissonant Whispers", 1, "Enchantment", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Divine Favor", 1, "Transmutation", "Bonus Action", "Self", "Concentration, up to 1 minute", True, False,
    ...
    ("Entangle", 1, "Conjuration", "Action", "90 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Expeditious Retreat", 1, "Transmutation", "Bonus Action", "Self", "Concentration, up to 10 minutes", True, False,
    ...
    ("Faerie Fire", 1, "Evocation", "Action", "60 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("False Life", 1, "Necromancy", "Action", "Self", "1 hour", False, False,
    ...
    ("Feather Fall", 1, "Transmutation", "Reaction", "60 feet", "1 minute", False, False,
    ...
    ("Fog Cloud", 1, "Conjuration", "Action", "120 feet", "Concentration, up to 1 hour", True, False,
    ...
    ("Goodberry", 1, "Transmutation", "Action", "Touch", "Instantaneous", False, False,
    ...
    ("Grease", 1, "Conjuration", "Action", "60 feet", "1 minute", False, False,
    ...
    ("Guiding Bolt", 1, "Evocation", "Action", "120 feet", "1 round", False, False,
    ...
    ("Healing Word", 1, "Abjuration", "Bonus Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Hellish Rebuke", 1, "Evocation", "Reaction", "60 feet", "Instantaneous", False, False,
    ...
    ("Heroism", 1, "Enchantment", "Action", "Touch", "Concentration, up to 1 minute", True, False,
    ...
    ("Hex", 1, "Enchantment", "Bonus Action", "90 feet", "Concentration, up to 1 hour", True, False,
    ...
    ("Hunter's Mark", 1, "Divination", "Bonus Action", "90 feet", "Concentration, up to 1 hour", True, False,
    ...
    ("Ice Knife", 1, "Conjuration", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Magic Missile", 1, "Evocation", "Action", "120 feet", "Instantaneous", False, False,
    ...
    ("Protection from Evil and Good", 1, "Abjuration", "Action", "Touch", "Concentration, up to 10 minutes", True, False,
    ...
    ("Ray of Sickness", 1, "Necromancy", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Shield", 1, "Abjuration", "Reaction", "Self", "1 round", False, False,
    ...
    ("Shield of Faith", 1, "Abjuration", "Bonus Action", "60 feet", "Concentration, up to 10 minutes", True, False,
    ...
    ("Silent Image", 1, "Illusion", "Action", "60 feet", "Concentration, up to 10 minutes", True, False,
    ...
    ("Sleep", 1, "Enchantment", "Action", "90 feet", "1 minute", False, False,
    ...
    ("Speak with Animals", 1, "Divination", "Action", "Self", "10 minutes", False, True,
     ["Bard", "Druid", "Ranger"], "Gain the ability to comprehend and verbally communicate with beasts for the duration."),
    ("Tasha's Hideous Laughter", 1, "Enchantment", "Action", "30 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Thunderwave", 1, "Evocation", "Action", "Self (15-foot cube)", "Instantaneous", False, False,
    ...
    ("Unseen Servant", 1, "Conjuration", "Action", "60 feet", "1 hour", False, True,
    ...
    ("Witch Bolt", 1, "Evocation", "Action", "30 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Wrathful Smite", 1, "Necromancy", "Bonus Action", "Self", "Concentration, up to 1 minute", True, False,
    ...
    # -------------------------------------------------------------- 2ND LEVEL
    ("Aid", 2, "Abjuration", "Action", "30 feet", "8 hours", False, False,
    ...
    ("Blindness/Deafness", 2, "Transmutation", "Action", "30 feet", "1 minute", False, False,
    ...
    ("Blur", 2, "Illusion", "Action", "Self", "Concentration, up to 1 minute", True, False,
    ...
    ("Crown of Madness", 2, "Enchantment", "Action", "120 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Darkness", 2, "Evocation", "Action", "60 feet", "Concentration, up to 10 minutes", True, False,
    ...
    ("Darkvision", 2, "Transmutation", "Action", "Touch", "8 hours", False, False,
     ["Druid", "Ranger", "Sorcerer", "Wizard"], "Touch a willing creature. For the duration, that creature has Darkvision out to 60 feet."),
    ("Detect Thoughts", 2, "Divination", "Action", "Self", "Concentration, up to 1 minute", True, False,
     ["Bard", "Sorcerer", "Wizard"], "For the duration, you can read the surface thoughts of certain creatures within 30 feet."),
    ("Dragon's Breath", 2, "Transmutation", "Bonus Action", "Touch", "Concentration, up to 1 minute", True, False,
    ...
    ("Enhance Ability", 2, "Transmutation", "Action", "Touch", "Concentration, up to 1 hour", True, False,
    ...
    ("Enlarge/Reduce", 2, "Transmutation", "Action", "30 feet", "Concentration, up to 1 minute", True, False,
     ["Sorcerer", "Wizard"], "Cause a creature or object to grow larger or smaller for the duration."),
    ("Find Traps", 2, "Divination", "Action", "120 feet", "Instantaneous", False, False,
    ...
    ("Flaming Sphere", 2, "Evocation", "Action", "60 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Heat Metal", 2, "Transmutation", "Action", "60 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Hold Person", 2, "Enchantment", "Action", "60 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Invisibility", 2, "Illusion", "Action", "Touch", "Concentration, up to 1 hour", True, False,
    ...
    ("Knock", 2, "Transmutation", "Action", "60 feet", "Instantaneous", False, False,
     ["Bard", "Sorcerer", "Wizard"], "Choose an object that is locked or barred within range. A lock or bar on the object opens."),
    ("Levitate", 2, "Transmutation", "Action", "60 feet", "Concentration, up to 10 minutes", True, False,
    ...
    ("Magic Weapon", 2, "Transmutation", "Bonus Action", "Touch", "Concentration, up to 1 hour", True, False,
     ["Paladin", "Ranger", "Sorcerer", "Wizard"], "Touch a nonmagical weapon. Until the spell ends, that weapon becomes a +1 magic weapon."),
    ("Mirror Image", 2, "Illusion", "Action", "Self", "1 minute", False, False,
    ...
    ("Misty Step", 2, "Conjuration", "Bonus Action", "Self", "Instantaneous", False, False,
    ...
    ("Moonbeam", 2, "Evocation", "Action", "120 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Phantasmal Force", 2, "Illusion", "Action", "60 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Protection from Poison", 2, "Abjuration", "Action", "Touch", "1 hour", False, False,
    ...
    ("Ray of Enfeeblement", 2, "Necromancy", "Action", "60 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Rope Trick", 2, "Transmutation", "Action", "Touch", "1 hour", False, False,
    ...
    ("Scorching Ray", 2, "Evocation", "Action", "120 feet", "Instantaneous", False, False,
    ...
    ("See Invisibility", 2, "Divination", "Action", "Self", "1 hour", False, False,
    ...
    ("Shatter", 2, "Evocation", "Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Silence", 2, "Illusion", "Action", "120 feet", "Concentration, up to 10 minutes", True, True,
    ...
    ("Spider Climb", 2, "Transmutation", "Action", "Touch", "Concentration, up to 1 hour", True, False,
    ...
    ("Suggestion", 2, "Enchantment", "Action", "30 feet", "Concentration, up to 8 hours", True, False,
    ...
    ("Web", 2, "Conjuration", "Action", "60 feet", "Concentration, up to 1 hour", True, False,
    ...
    ("Bestow Curse", 3, "Necromancy", "Action", "Touch", "Concentration, up to 1 minute", True, False,
    ...
    ("Call Lightning", 3, "Conjuration", "Action", "120 feet", "Concentration, up to 10 minutes", True, False,
    ...
    ("Counterspell", 3, "Abjuration", "Reaction", "60 feet", "Instantaneous", False, False,
    ...
    ("Dispel Magic", 3, "Abjuration", "Action", "120 feet", "Instantaneous", False, False,
    ...
    ("Fear", 3, "Illusion", "Action", "Self (30-foot cone)", "Concentration, up to 1 minute", True, False,
    ...
    ("Fireball", 3, "Evocation", "Action", "150 feet", "Instantaneous", False, False,
    ...
    ("Fly", 3, "Transmutation", "Action", "Touch", "Concentration, up to 10 minutes", True, False,
     ["Sorcerer", "Warlock", "Wizard"], "Target a willing creature. For the duration, the target gains a flying speed of 60 feet."),
    ("Gaseous Form", 3, "Transmutation", "Action", "Touch", "Concentration, up to 1 hour", True, False,
    ...
    ("Haste", 3, "Transmutation", "Action", "30 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Hypnotic Pattern", 3, "Illusion", "Action", "120 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Lightning Bolt", 3, "Evocation", "Action", "Self (100-foot line)", "Instantaneous", False, False,
    ...
    ("Mass Healing Word", 3, "Abjuration", "Bonus Action", "60 feet", "Instantaneous", False, False,
    ...
    ("Major Image", 3, "Illusion", "Action", "120 feet", "Concentration, up to 10 minutes", True, False,
    ...
    ("Nondetection", 3, "Abjuration", "Action", "Touch", "8 hours", False, False,
     ["Bard", "Ranger", "Wizard"], "For the duration, you hide a target that you touch from divination magic."),
    ("Plant Growth", 3, "Transmutation", "Action", "150 feet", "Instantaneous", False, False,
    ...
    ("Protection from Energy", 3, "Abjuration", "Action", "Touch", "Concentration, up to 1 hour", True, False,
    ...
    ("Remove Curse", 3, "Abjuration", "Action", "Touch", "Instantaneous", False, False,
     ["Cleric", "Paladin", "Warlock", "Wizard"], "At your touch, all curses affecting one creature or object end."),
    ("Sending", 3, "Divination", "Action", "Unlimited", "1 round", False, False,
    ...
    ("Sleet Storm", 3, "Conjuration", "Action", "150 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Slow", 3, "Transmutation", "Action", "120 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Stinking Cloud", 3, "Conjuration", "Action", "90 feet", "Concentration, up to 1 minute", True, False,
    ...
    ("Tongues", 3, "Divination", "Action", "Touch", "1 hour", False, False,
    ...
    ("Vampiric Touch", 3, "Necromancy", "Action", "Self", "Concentration, up to 1 minute", True, False,
    ...
    ("Water Breathing", 3, "Transmutation", "Action", "30 feet", "24 hours", False, True,
     ["Druid", "Ranger", "Sorcerer", "Wizard"], "Give up to ten willing creatures the ability to breathe underwater until the spell ends."),
    ("Water Walk", 3, "Transmutation", "Action", "30 feet", "1 hour", False, True,
    ...
    ("Wind Wall", 3, "Evocation", "Action", "120 feet", "Concentration, up to 1 minute", True, False,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Build a nameâ†’pk map for CharacterClass once
        ...
        with transaction.atomic():
            for entry in SPELL_DATA:
                ...
                normalized_casting_time = _CASTING_TIME_MAP.get(casting_time.strip().lower(), casting_time)
                ...
                if not is_new:
                    # Always keep basic structural fields in sync.
                    # Do NOT overwrite damage/components/higher_levels/description
                    # — update_spell_data may have enriched those from JSON files.
                    update_fields = []
                    if spell.level != level:
                        spell.level = level; update_fields.append('level')
                    if spell.school != school:
                        spell.school = school; update_fields.append('school')
                    if spell.casting_time != normalized_casting_time:
                        spell.casting_time = normalized_casting_time; update_fields.append('casting_time')
                    if spell.range != range_:
                        spell.range = range_; update_fields.append('range')
                    if spell.duration != duration:
                        spell.duration = duration; update_fields.append('duration')
                    if spell.concentration != conc:
                        spell.concentration = conc; update_fields.append('concentration')
                    if spell.ritual != ritual:
                        spell.ritual = ritual; update_fields.append('ritual')
                    if update_fields:
                        spell.save(update_fields=update_fields)
        ...
        if missing_classes:
            self.stdout.write(self.style.WARNING(
                f'Warning â€” these class names were not found in the DB and were skipped: {sorted(missing_classes)}'
            ))
